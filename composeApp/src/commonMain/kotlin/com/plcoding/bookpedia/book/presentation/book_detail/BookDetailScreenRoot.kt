...
import cmp_bookpedia.composeapp.generated.resources.decription_not_available
                ...
                Row(
                    ...
                    state.book.averageRating?.let { rating ->
                        TitledContent(
                            ...
                            BookChip {
                                Text(text = round((rating * 10) / 10.0).toString())
                                Icon(
                ...
                if (state.isLoading) {
                    ...
                    Text(
                        text = if (state.book.description.isNullOrBlank()) {
                            stringResource(Res.string.decription_not_available)
                        } else {
